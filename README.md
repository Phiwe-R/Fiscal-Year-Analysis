...
1. **Save documents on your Google Drive and Open Notebook in Colab**
   ...
   - Follow these intructions , otherwise the pyPDFDirectory function  from the notebook will not load the pdf because it  wants a real directory folder not a temporary session
